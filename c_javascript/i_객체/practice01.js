...
// - forEach : 반환값 없음, 전체 요소에 동일한 기능 적용

// - map : 새로운 배열을 반환, 전체 요소에 동일한 기능 적용
...
console.log(personCopy);  // { name: '정쪼꼬', age: 20, isStudent: true }
console.log(person);  // { name: '정수은', age: 20, isStudent: true }
