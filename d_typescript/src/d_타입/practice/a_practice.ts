...
function doubleOrNothing(num: number | string): void {
...
console.log(doubleOrNothing('쪼꼬')); // 쪼꼬
...
const adminPerson1: Person = {
  id: 1,
  isAdmin: true
};

const adminPerson2: Person = {
  id: 2,
  username: '정수은'
};
...
console.log(identifyPerson(adminPerson1));  // 관리자 계정입니다.
console.log(identifyPerson(adminPerson2));  // 유저 계정입니다.
